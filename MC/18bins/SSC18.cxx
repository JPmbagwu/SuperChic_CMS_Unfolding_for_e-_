...
void ManuelElectronResponseMatrix() {
    ...
    string outfile = "SSC18enhanced_superchic2018_dielectrons_full.root";
    ...
    TFile *dataFile = new TFile("/afs/cern.ch/user/j/jmbagwu/NEWSC/e-/delta_phi_histogram_electron_nozdc02.root", "READ");
    ...
    cUnfoldDataOverAcceptance->SaveAs("SSC18UnfoldDataOverAcceptance.pdf");
    ...
    cDataUnfold->Update();
    cDataUnfold->SaveAs("SSC18bottom_line_test.pdf");
    ...
    cUnfoldVsGen->Update();
    cUnfoldVsGen->SaveAs("SSC18UnfoldVsGenTruth.pdf");
    ...
    if (hResponse) {
        ...
        c->Update();
        c->Draw();
        c->Print("SSC18SuperchicResponseMatrix.pdf");
        delete c;
    }
