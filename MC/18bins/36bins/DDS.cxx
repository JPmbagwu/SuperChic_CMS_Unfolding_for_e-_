...
float GetAngle(float vPX1, float vPY1, float vPX2, float vPY2) {
    ...
    if (DielectronMag == 0 || ElectronMag == 0) return 0.0;
...
void ManuelElectronResponseMatrix() {
    ...
    string outfile_pseudo = "DDS10_pseudodata_25.root";
    string outfile_response = "DDS10_response_75.root";
    ...
    f_pseudo.cd();
    TH1F *pseudodata = new TH1F("pseudodata", "Reconstructed #Delta#phi (25% subset - PSEUDODATA)", xbinz, xrangeMin, xrangeMax);
    TH1F *genTrue = new TH1F("genTrue", "True Generator Level #Delta#phi (25% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *gen = new TH1F("gen", "Generator Level #Delta#phi (25% subset)", xbinz, xrangeMin, xrangeMax);
    ...
    TH1F *hreco = new TH1F("hreco", "Reconstructed #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hrecoTrue = new TH1F("hrecoTrue", "True Reconstructed #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hrecoFake = new TH1F("hrecoFake", "Fake Reconstructed #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hgen = new TH1F("hgen", "Generator Level #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hgenTrue = new TH1F("hgenTrue", "True Generator Level #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hgenMiss = new TH1F("hgenMiss", "Missed Generator Level #Delta#phi (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hgenAll = new TH1F("hgenAll", "All Generator Level #Delta#phi (no cuts)", xbinz, xrangeMin, xrangeMax);
    TH1F *hRDeltaPhi = new TH1F("hRDeltaPhi", "Reconstructed DeltaPhi Explicit (25% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hGDeltaPhi = new TH1F("hGDeltaPhi", "Generator DeltaPhi Explicit (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hEfficiency = new TH1F("hEfficiency", "Efficiency;#Delta#phi;Efficiency (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hPurity = new TH1F("hPurity", "Purity;#Delta#phi;Purity (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hAcceptance = new TH1F("hAcceptance", "Acceptance;#Delta#phi;Acceptance (75% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hUnfoldedPseudodataPurityCorrected = new TH1F("hUnfoldedPseudodataPurityCorrected", "Unfolded Purity-Corrected Pseudodata #Delta#phi (25% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hUnfoldedPseudodataPurityCorrectedOverAcceptance = new TH1F("hUnfoldedPseudodataPurityCorrectedOverAcceptance", "Unfolded Purity-Corrected Pseudodata #Delta#phi / Acceptance (25% subset, 75% acceptance)", xbinz, xrangeMin, xrangeMax);
    TH1F *hUnfoldedRecoTrue = new TH1F("hUnfoldedRecoTrue", "Unfolded True Reconstructed #Delta#phi (25% subset)", xbinz, xrangeMin, xrangeMax);
    TH1F *hUnfoldedRecoTrueOverAcceptance = new TH1F("hUnfoldedRecoTrueOverAcceptance", "Unfolded True Reconstructed #Delta#phi / Acceptance (25% subset, 75% acceptance)", xbinz, xrangeMin, xrangeMax);
    TH1F *hRefolded = new TH1F("hRefolded", "Refolded Purity-Corrected Pseudodata #Delta#phi (25% subset)", xbinz, xrangeMin, xrangeMax);
    ...
    for (int j = 0; j < 0.25 * numberentry; j++) {
        ...
        if (idx_electron != -1 && idx_positron != -1) {
            ...
            float GenElePx = GLep1.Pt() * cos(GLep1.Phi());
            float GenElePy = GLep1.Pt() * sin(GLep1.Phi());
        ...
        if (Twoelectron && Twotrk) {
            ...
            EleP = ((*reco_eleCharge)[0] == 1) ? 0 : 1;
            EleN = 1 - EleP;
            iRp = EleP;
            iRn = EleN;
            
            RLep1.SetPtEtaPhiM((*reco_elePt)[EleP], (*reco_eleEta)[EleP], (*reco_elePhi)[EleP], Cuts::electronMass);
            RLep2.SetPtEtaPhiM((*reco_elePt)[EleN], (*reco_eleEta)[EleN], (*reco_elePhi)[EleN], Cuts::electronMass);
            RDiele = RLep1 + RLep2;
            
            float RecoDielePx = RDiele.Pt() * cos(RDiele.Phi());
            float RecoDielePy = RDiele.Pt() * sin(RDiele.Phi());
            float RecoElePx = RLep2.Pt() * cos(RLep2.Phi());
            float RecoElePy = RLep2.Pt() * sin(RLep2.Phi());
    ...
    pseudodataPurityCorrected->SetTitle("Purity-Corrected Pseudodata #Delta#phi (25% subset)");
    ...
    hUnfoldedPseudodataPurityCorrected->GetXaxis()->SetTitle("#Delta#phi = #phi_{ee} - #phi_{e-}");
    ...
    hRefolded->GetXaxis()->SetTitle("#Delta#phi = #phi_{ee} - #phi_{e-}");
    ...
    hUnfoldedPseudodataPurityCorrectedOverAcceptance->GetXaxis()->SetTitle("#Delta#phi = #phi_{ee} - #phi_{e-}");
    ...
    hUnfoldedRecoTrue->GetXaxis()->SetTitle("#Delta#phi = #phi_{ee} - #phi_{e-}");
    ...
    hUnfoldedRecoTrueOverAcceptance->GetXaxis()->SetTitle("#Delta#phi = #phi_{ee} - #phi_{e-}");
    ...
    TCanvas *cSplitMCValidation = new TCanvas("cSplitMCValidation", "Split MC Test: Unfolded Pseudodata vs Generator Truth (75% subset)", 900, 700);
    ...
    cSplitMCValidation->SaveAs("DDS10SplitMCValidation_split_25_75.pdf");
    ...
    cRefoldValidation->SaveAs("DDS10RefoldValidation_Superchic_electron.pdf");
    ...
    cUnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25->SaveAs("DDS10UnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25_Superchic_electron.pdf");
    ...
    cUnfoldedRecoTrueOverAcceptanceVsGenTrue25->SaveAs("DDS10UnfoldedRecoTrueOverAcceptanceVsGenTrue25_Superchic_electron.pdf");
