...
void ManuelElectronResponseMatrix() {
    ...
    string outfile = "GSC36enhanced_superchic2018_dielectrons_full.root";
    ...
    cout << "Total statistical uncertainty after unfolding (UnfoldData): " << total_unc_after << endl;
    ...
    cUnfoldDataOverAcceptance->SaveAs("GSC36UnfoldDataOverAcceptance.pdf");
    ...
    cDataUnfold->Update();
    cDataUnfold->SaveAs("GSC36bottom_line_test.pdf");
    ...
    cUnfoldVsGen->Update();
    cUnfoldVsGen->SaveAs("GSC36UnfoldVsGenTruth.pdf");
    ...
    if (hResponse) {
        ...
        c->Update();
        c->Draw();
        c->Print("GSC36SuperchicResponseMatrix.pdf");
        delete c;
    }
