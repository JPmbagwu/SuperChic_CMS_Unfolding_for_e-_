...
void ManuelElectronResponseMatrix() {
    ...
    string outfile = "FDC36enhanced_superchic2018_dielectrons_full.root";
    ...
    cUnfoldDataOverAcceptance->SaveAs("FDC36UnfoldDataOverAcceptance.pdf");
    ...
    cDataUnfold->Update();
    cDataUnfold->SaveAs("FDC36bottom_line_test.pdf");
    ...
    cUnfoldVsGen->Update();
    cUnfoldVsGen->SaveAs("FDC36UnfoldVsGenTruth.pdf");
...
//        latex.DrawLatex(0.84, 0.20, "p_{T}_{e} > 0.0 GeV");
        ...
        c->Update();
        c->Draw();
        c->Print("FDC36SuperchicResponseMatrix.pdf");
        delete c;
    }
