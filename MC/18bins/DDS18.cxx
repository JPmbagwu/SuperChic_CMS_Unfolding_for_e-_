...
void ManuelElectronResponseMatrix() {
    ...
    string outfile_pseudo = "DDS18_pseudodata_25.root";
    string outfile_response = "DDS18_response_75.root";
    ...
    cSplitMCValidation->SaveAs("DDS18SplitMCValidation_split_25_75.pdf");
    ...
    cRefoldValidation->SaveAs("DDS18RefoldValidation_Superchic_electron.pdf");
    ...
    cUnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25->SaveAs("DDS18UnfoldedPseudodataPurityCorrectedOverAcceptanceVsGen25_Superchic_electron.pdf");
    ...
    cUnfoldedRecoTrueOverAcceptanceVsGenTrue25->SaveAs("DDS18UnfoldedRecoTrueOverAcceptanceVsGenTrue25_Superchic_electron.pdf");
